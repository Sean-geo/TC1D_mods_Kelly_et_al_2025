...
'''
Modified version of Tc1D written by Dave whipp and modified by Sean Kelly

SK changes for Kelly et al., 2025: ero-type 8 allows for CLM removal with a mixing
time where the removed part of CLM is maintained at adiabat adjusted temp of 1300 C
from the time of CLM conplete removal until --mixing-time

--param13, and --param14 allow the lithosphere base to increase to 1500C between the 
interval --param13 and --param14. 


--ero-type 9 allows emplacement of two lava flows of thickness equal to the FD mesh size
 --ero-option6, 7, 8 def the time of 1st, and 2nd lava flows, and the lava temp respectively

--additional changes to plotting 

--addition changes allowig for a vertical fluid flux from the base of the crust up
between certain time intervals

--param15 , param16 and --param17 control fluid flux start time, stop time and flux
...
def main():
    ...
    thermal.add_argument(
        "--Mixing-time",
        dest="Mixing_time",
        help="Well mixed post-delamination mantle",
        nargs="+",
        default=[-1.0],
        type=float,
    )
    ...
    params = {
        ...
        "param11": args.param11,
        "param12": args.param12,
        "param13": args.param13,
        "param14": args.param14,
        "param15": args.param15,
        "param16": args.param16,
        "param17": args.param17,
    }
