...
import argparse
import sys
import TC1D_M1 as tc1d

# import cProfile
# from gooey import Gooey
'''
Modified version of Tc1D written by Dave whipp and modeified by Sean Kelly
...
def main():
    ...
    thermal.add_argument(
        "--param13",
        dest="param13",
        help="Set lithoshere base to 1500oC start time",
        nargs="+",
        default=[0.0],
        type=float,
    )
    thermal.add_argument(
        "--param14",
        dest="param14",
        help="Set lithoshere base to 1500oC stop time",
        nargs="+",
        default=[0.0],
        type=float,
    )
    ...
    erosion.add_argument(
        "--ero-type",
        dest="ero_type",
        help="Type of erosion model (1, 2, 3, 4, 5 - see GitHub docs), SK erotype 8 is a new CLM removal with mixing ero_type 9 is lava flow model  ",
        nargs="+",
        default=[1],
        type=int,
    )
